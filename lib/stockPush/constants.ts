...
export interface StockPushChannel {
  ...
  /**
   * Wayfair dropship hesabi (label, orn 'mdn'). Verilirse SKU evreni channel_prices
   * yerine DataBridge Wayfair katalogundan gelir + push body'sine account eklenir.
   */
  wayfairAccount?: string;
}
