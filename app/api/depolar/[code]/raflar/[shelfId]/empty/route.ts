...
export const POST = withRoute<{ code: string; shelfId: string }>(
  { skipAuth: true, rateLimit: 'write', fallbackMessage: 'Rafı boşaltma başarısız' },
  async ({ request, params }) => {
    ...
    // Business error -> 400 (transaction içindeki throw): inner try/catch korunuyor.
    try {
