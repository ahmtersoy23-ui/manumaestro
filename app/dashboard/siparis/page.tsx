...
const STATUS_META: Record<StatusKey, { label: string; badge?: string; desc: string; icon: typeof CheckCircle2; accent: string; ring: string; dot: string }> = {
  ...
  wayfairBekliyor:{ label: 'Etiket Bekliyor', badge: 'WF',  desc: 'Wayfair tracking girilecek (AWB almaz)', icon: Tag, accent: 'text-fuchsia-700', ring: 'ring-fuchsia-500 bg-fuchsia-50', dot: 'bg-fuchsia-500' },
