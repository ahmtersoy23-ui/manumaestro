/**
 * Shipments Client — tab switching, create form, listing.
 *
 * Server Component shipments + canCreate'i prop olarak geçer. Tab değişimi
 * router.replace(?tab=X) ile yeni RSC render tetikler — fresh data
 * prop olarak gelir, fetch kodu yok.
 */
...
export function ShipmentsClient({ activeTab, initialShipments, canCreate }: Props) {
  ...
  const switchTab = (tab: Tab) => {
    startTransition(() => router.replace(`/dashboard/shipments?tab=${tab}`));
  };
